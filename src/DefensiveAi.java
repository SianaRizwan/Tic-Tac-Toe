...
public class DefensiveAi implements IAi {
    ...
    DefensiveAi(JButton[] button, String[][] board) {
        ...
        calledButton = button;
        calledBoard = board;
        System.out.println("Insyd Defensive");
    }
...
//            //Row
//            if ((calledBoard[i][0].equals(player)) && (board[i][1].equals(player)) && (board[i][2].equals(player))) {
//                return true;
//            }
//            //Column
...
//        }
        ...
        while (true) {
            ...
            if (loopCounter == 500) {
                System.out.println("INSIDE(DEFENSIVE) IF LOOP CROSSED " + loopCounter);
                break;
            }
            System.out.println("OUTSIDE(DEFENSIVE) IF ELSE Freespot inside Players.Computer.Players.Computer: " + btnCoord);
            System.out.println("OUTSIDE(DEFENSIVE) IF I:" + ai_i + " J:" + ai_j + "Gameboard Current State: " + GameLogic.currentState[btnCoord] + " Board: " + Board);
